...
- ## **Pet sitter Profile:**
  ...
  - ### **Toast Window:**
    ...
    - Toast box has an informative task.
    - It display in the center of the page at the top.
    - It contain short texts informing about mistakes made by the user, warnings, errors or actions taken by the system.
